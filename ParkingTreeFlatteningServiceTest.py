...
import ParkingTreeFlatteningService


class ParkingTreeFlatteningServiceTest(unittest.TestCase):
    test_cases = [
        [
        ...
        [
            ["HOUR,PA K NG,7A.M. TO 6P.", "HOUR,PA K NG,oP. (A.M.TO,"],
            40140
        ],
        # Takes long time
        # [
        #     ["STOPPING,  02/07/2020, -, 05/09/2020,  11:30PM - 7:00AM,  Fri,  Sat,  Sun", "STOPPING,  02/07/2020, -, 05/09/2020,  11:30PM - 7:00AM,  Frl,  Sat,  Sun"],
        #     3079296
        # ],
    ]
    ...
    def test(self):
        parking_tree_flattening_Service = ParkingTreeFlatteningService.ParkingTreeFlatteningService()
        ...
        for test_case in self.test_cases:
            ...
            # call parking_tree_flattening_Service
            actual_result = parking_tree_flattening_Service.flatten_tree(tree_head)

            self.assertEqual(test_case[1], len(actual_result))
